/**
 * Upserts LEHENGA CHOLI Catalog #3 only.
 * Idempotent — does not modify lehenga-choli, lehenga-choli-02, Lehenga Collection, CHHABILI, or JOBANIYU.
 */
...
/** Own primary image only — do not share gallery frames with other LEHENGA CHOLI catalogs. */
...
async function main() {
  ...
  console.log(`LEHENGA CHOLI catalog #3 ready: ${product.id}`)
