/**
 * Upserts LEHENGA CHOLI Catalog #3 (dark green) only.
 * Restores primary still + appends the target gallery image.
 * Idempotent — does not modify lehenga-choli / lehenga-choli-02 / other categories.
 */
...
/** Keep existing primary first; target dark-green still appended. */
const IMAGES: string[] = [
  IMAGE,
...
async function main() {
  ...
  console.log(`LEHENGA CHOLI dark-green catalog ready: ${product.id}`)
