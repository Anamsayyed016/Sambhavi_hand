 ...
 * Gallery: keep existing images; append video last.
...
/** Catalog #2 (green): keep all existing; append video last. */
const IMAGES: string[] = [
  IMAGE_1,
  IMAGE_2,
  IMAGE_3,
...
async function main() {
  ...
  const product = await prisma.product.upsert({
    where: { slug: 'chhabili-lehenga-set-03' },
    create: {
      slug: 'chhabili-lehenga-set-03',
      sku: 'SH-CHHABILI-LEHENGA-03',
      name: 'CHHABILI',
  ...
  console.log(`CHHABILI product #3 ready: ${product.id}`)
