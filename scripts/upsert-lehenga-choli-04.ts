/**
 * Upserts LEHENGA CHOLI Catalog #4 only.
 * Idempotent — does not modify lehenga-choli / -02 / -03 or other categories.
 */
...
async function main() {
  ...
  const product = await prisma.product.upsert({
    where: { slug: 'lehenga-choli-04' },
    create: {
      slug: 'lehenga-choli-04',
      sku: 'SH-LEHENGA-CHOLI-04',
      name: 'Lehenga Choli🌷',
  ...
  console.log(`LEHENGA CHOLI catalog #4 ready: ${product.id}`)
