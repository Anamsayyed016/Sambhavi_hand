...
export const products: Product[] = [
  {
    ...
    images: ['/images/product-silk.png', '/images/editorial-drape.png'],
    category: 'Silk',
  ...
  },
  {
    ...
    images: ['/images/product-banarasi.png', '/images/product-banarasi-detail.png'],
    category: 'Banarasi',
  ...
  },
  {
    ...
    images: ['/images/product-kanjeevaram.png', '/images/editorial-drape.png'],
    category: 'Silk',
